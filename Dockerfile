...
RUN wget https://surfer.nmr.mgh.harvard.edu/pub/dist/freesurfer/6.0.0/freesurfer-Linux-centos6_x86_64-stable-pub-v6.0.0.tar.gz /tmp/ && \
...
RUN wget https://fsl.fmrib.ox.ac.uk/fsldownloads/fslinstaller.py /tmp/ && \
