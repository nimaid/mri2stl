...
# Modified version for mri2stl Docker container
...
# Did the subcortical model get created?
...
xvfb-run -a -s "-screen 0 800x600x24" $MESHLAB_DIR/meshlabserver -i $SUBJECTS_DIR/final.stl -o $SUBJECTS_DIR/final_s.stl -s $MAIN_DIR/smoothing.mlx
